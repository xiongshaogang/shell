...
bfee_file=/data1/home/jsusr1/center/scripts/spdz/BFEE${bal_month}${file_seq}.571	# BFEEYYYYMMNNN.ZZZ
# clear
...
WHERE a.bill_month in (to_char(add_months(to_date($1,'yyyymm'),-4),'yyyymm'),to_char(add_months(to_date($1,'yyyymm'),-3),'yyyymm'),to_char(add_months(to_date($1,'yyyymm'),-2),'yyyymm'))
