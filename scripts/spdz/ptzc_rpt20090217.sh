...
create table temp_pushmail_bill_$1 as select * from aicbs.acc_user_bill_dtl_571@BCA_AIQRY where 
bill_month='$1' and acc_code=42001860;
insert into temp_pushmail_bill_$1 select * from aicbs.acc_user_bill_dtl_572@BCA_AIQRY where 
bill_month='$1' and acc_code=42001860;
insert into temp_pushmail_bill_$1 select * from aicbs.acc_user_bill_dtl_573@BCA_AIQRY where 
bill_month='$1' and acc_code=42001860;
insert into temp_pushmail_bill_$1 select * from aicbs.acc_user_bill_dtl_575@BCA_AIQRY where 
bill_month='$1' and acc_code=42001860;
insert into temp_pushmail_bill_$1 select * from aicbs.acc_user_bill_dtl_576@BCA_AIQRY where 
bill_month='$1' and acc_code=42001860;
insert into temp_pushmail_bill_$1 select * from aicbs.acc_user_bill_dtl_570@BCB_AIQRY where 
bill_month='$1' and acc_code=42001860;
insert into temp_pushmail_bill_$1 select * from aicbs.acc_user_bill_dtl_574@BCB_AIQRY where 
bill_month='$1' and acc_code=42001860;
insert into temp_pushmail_bill_$1 select * from aicbs.acc_user_bill_dtl_577@BCB_AIQRY where 
bill_month='$1' and acc_code=42001860;
insert into temp_pushmail_bill_$1 select * from aicbs.acc_user_bill_dtl_578@BCB_AIQRY where 
bill_month='$1' and acc_code=42001860;
insert into temp_pushmail_bill_$1 select * from aicbs.acc_user_bill_dtl_579@BCB_AIQRY where 
bill_month='$1' and acc_code=42001860;
insert into temp_pushmail_bill_$1 select * from aicbs.acc_user_bill_dtl_580@BCB_AIQRY where 
bill_month='$1' and acc_code=42001860;
insert into temp_pushmail_bill_$1 select * from aicbs.acc_user_bill_dtl_j_571_$1@BCA_AIQRY where 
bill_month='$1' and acc_code=42001860;
insert into temp_pushmail_bill_$1 select * from aicbs.acc_user_bill_dtl_j_572_$1@BCA_AIQRY where 
bill_month='$1' and acc_code=42001860;
insert into temp_pushmail_bill_$1 select * from aicbs.acc_user_bill_dtl_j_573_$1@BCA_AIQRY where 
bill_month='$1' and acc_code=42001860;
insert into temp_pushmail_bill_$1 select * from aicbs.acc_user_bill_dtl_j_575_$1@BCA_AIQRY where 
bill_month='$1' and acc_code=42001860;
insert into temp_pushmail_bill_$1 select * from aicbs.acc_user_bill_dtl_j_576_$1@BCA_AIQRY where 
bill_month='$1' and acc_code=42001860;
insert into temp_pushmail_bill_$1 select * from aicbs.acc_user_bill_dtl_j_570_$1@BCB_AIQRY where 
bill_month='$1' and acc_code=42001860;
insert into temp_pushmail_bill_$1 select * from aicbs.acc_user_bill_dtl_j_574_$1@BCB_AIQRY where 
bill_month='$1' and acc_code=42001860;
insert into temp_pushmail_bill_$1 select * from aicbs.acc_user_bill_dtl_j_577_$1@BCB_AIQRY where 
bill_month='$1' and acc_code=42001860;
insert into temp_pushmail_bill_$1 select * from aicbs.acc_user_bill_dtl_j_578_$1@BCB_AIQRY where 
bill_month='$1' and acc_code=42001860;
insert into temp_pushmail_bill_$1 select * from aicbs.acc_user_bill_dtl_j_579_$1@BCB_AIQRY where 
bill_month='$1' and acc_code=42001860;
insert into temp_pushmail_bill_$1 select * from aicbs.acc_user_bill_dtl_j_580_$1@BCB_AIQRY where 
bill_month='$1' and acc_code=42001860;
commit;
...
create table temp_blackberry_bill_$1 as select * from aicbs.acc_user_bill_dtl_571@BCA_AIQRY where 
bill_month='$1' and acc_code=42000030;
insert into temp_blackberry_bill_$1 select * from aicbs.acc_user_bill_dtl_572@BCA_AIQRY where 
bill_month='$1' and acc_code=42000030;
insert into temp_blackberry_bill_$1 select * from aicbs.acc_user_bill_dtl_573@BCA_AIQRY where 
bill_month='$1' and acc_code=42000030;
insert into temp_blackberry_bill_$1 select * from aicbs.acc_user_bill_dtl_575@BCA_AIQRY where 
bill_month='$1' and acc_code=42000030;
insert into temp_blackberry_bill_$1 select * from aicbs.acc_user_bill_dtl_576@BCA_AIQRY where 
bill_month='$1' and acc_code=42000030;
insert into temp_blackberry_bill_$1 select * from aicbs.acc_user_bill_dtl_570@BCB_AIQRY where 
bill_month='$1' and acc_code=42000030;
insert into temp_blackberry_bill_$1 select * from aicbs.acc_user_bill_dtl_574@BCB_AIQRY where 
bill_month='$1' and acc_code=42000030;
insert into temp_blackberry_bill_$1 select * from aicbs.acc_user_bill_dtl_577@BCB_AIQRY where 
bill_month='$1' and acc_code=42000030;
insert into temp_blackberry_bill_$1 select * from aicbs.acc_user_bill_dtl_578@BCB_AIQRY where 
bill_month='$1' and acc_code=42000030;
insert into temp_blackberry_bill_$1 select * from aicbs.acc_user_bill_dtl_579@BCB_AIQRY where 
bill_month='$1' and acc_code=42000030;
insert into temp_blackberry_bill_$1 select * from aicbs.acc_user_bill_dtl_580@BCB_AIQRY where 
bill_month='$1' and acc_code=42000030;
insert into temp_blackberry_bill_$1 select * from aicbs.acc_user_bill_dtl_j_571_$1@BCA_AIQRY where 
bill_month='$1' and acc_code=42000030;
insert into temp_blackberry_bill_$1 select * from aicbs.acc_user_bill_dtl_j_572_$1@BCA_AIQRY where 
bill_month='$1' and acc_code=42000030;
insert into temp_blackberry_bill_$1 select * from aicbs.acc_user_bill_dtl_j_573_$1@BCA_AIQRY where 
bill_month='$1' and acc_code=42000030;
insert into temp_blackberry_bill_$1 select * from aicbs.acc_user_bill_dtl_j_575_$1@BCA_AIQRY where 
bill_month='$1' and acc_code=42000030;
insert into temp_blackberry_bill_$1 select * from aicbs.acc_user_bill_dtl_j_576_$1@BCA_AIQRY where 
bill_month='$1' and acc_code=42000030;
insert into temp_blackberry_bill_$1 select * from aicbs.acc_user_bill_dtl_j_570_$1@BCB_AIQRY where 
bill_month='$1' and acc_code=42000030;
insert into temp_blackberry_bill_$1 select * from aicbs.acc_user_bill_dtl_j_574_$1@BCB_AIQRY where 
bill_month='$1' and acc_code=42000030;
insert into temp_blackberry_bill_$1 select * from aicbs.acc_user_bill_dtl_j_577_$1@BCB_AIQRY where 
bill_month='$1' and acc_code=42000030;
insert into temp_blackberry_bill_$1 select * from aicbs.acc_user_bill_dtl_j_578_$1@BCB_AIQRY where 
bill_month='$1' and acc_code=42000030;
insert into temp_blackberry_bill_$1 select * from aicbs.acc_user_bill_dtl_j_579_$1@BCB_AIQRY where 
bill_month='$1' and acc_code=42000030;
insert into temp_blackberry_bill_$1 select * from aicbs.acc_user_bill_dtl_j_580_$1@BCB_AIQRY where 
bill_month='$1' and acc_code=42000030;
commit;
