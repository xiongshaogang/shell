...
create table temp_ydjs_200811  as 
select  * from aicbs.acc_user_bill_dtl_571@bca_aiqry a where a.acc_code like '8%1' and 
substr(a.acc_code,2,6) in (select sp_code from temp_ydjs) and a.bill_month='200811';
insert into temp_ydjs_200811
select  * from aicbs.acc_user_bill_dtl_572@bca_aiqry a where a.acc_code like '8%1' and 
substr(a.acc_code,2,6) in (select sp_code from temp_ydjs) and a.bill_month='200811';
insert nto temp_ydjs_200811
