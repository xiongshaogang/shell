...
# 退费上报文件
bfee_file=/data1/home/jsusr1/center/uploadfile/ivr/BFIVR${cur_month}001.571	# BFEEYYYYMMNNN.ZZZ
...
# bfee_file head
blanks=`printf "%33s" " "`
head="1046000571  46000000  001${now}01$blanks\r\n"
...
# bfee_file tail
tail="9046000000  46000571  001$linefmt"
