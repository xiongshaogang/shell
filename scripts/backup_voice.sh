...
#--------------------------------------------------------------------#
# 分析备份的预处理话单
# 备份策略: 备份N天前话单,先compress再tar,每天GW各一个文件
#--------------------------------------------------------------------#
...
# 备份策略: 备份10天前话单为tar,每天GW各一个文件,也可直接删除
#--------------------------------------------------------------------#
...
filepattern="N_GSM*"
filetype="drload_out"
#由于该文件占用空间较大，且无备份的必要，直接删除 by guyb 20070925
#BACKUP_WJ_VOICE
...
# 目录下还包括处理日志：log.ldr_${gw_type}.yyyymmdd*,每天一个
# 备份策略: 备份N天前话单为tar,每天每类GW一个文件,且不必压缩
# 保留3＋1备查
#--------------------------------------------------------------------#
...
# 目录下还包括处理日志：log.ldr_stat_${gw_type}.yyyymmdd*,每天一个
# 备份策略: 备份10天前话单为tar,每天GW共一个文件,且不必压缩
# 保留3＋1备查
#--------------------------------------------------------------------#
